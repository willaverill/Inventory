...
public class InventoryProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        Integer sold = values.getAsInteger(InventoryEntry.COLUMN_PRODUCT_SOLD);

        if (sold != null && sold < 0) {
            throw new IllegalArgumentException("Product requires valid amount sold");
        }
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(InventoryEntry.COLUMN_PRODUCT_NAME)) {
            ...
            if (name == null) {
                throw new IllegalArgumentException("Prodcut requires a name");
            }
        }
        ...
        if (values.containsKey(InventoryEntry.COLUMN_PRODUCT_SOLD)) {
            Integer sold = values.getAsInteger(InventoryEntry.COLUMN_PRODUCT_SOLD);
